            ...
            <main className="container mx-auto p-6">
                <div className="flex flex-col lg:flex-row gap-6 mb-6">
                    <div className="lg:w-2/3 bg-white rounded-lg shadow-lg overflow-visible relative">
                        <Slider {...settings} className="relative">
                            {images.map((src, i) => (
                                <div key={i} className="h-64 flex items-center justify-center bg-gray-200">
                ...
                <div className="bg-white shadow rounded-lg overflow-hidden">
                    <div className="flex border-b">
                        <button onClick={() => setActiveTab('basic')} className={`flex-1 py-3 text-center ${activeTab === 'basic' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600 hover:bg-gray-100'}`}>Basic Info</button>
                        <button onClick={() => setActiveTab('details')} className={`flex-1 py-3 text-center ${activeTab === 'details' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600 hover:bg-gray-100'}`}>Details</button>
                        <button onClick={() => setActiveTab('pricing')} className={`flex-1 py-3 text-center ${activeTab === 'pricing' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600 hover:bg-gray-100'}`}>Pricing</button>
                    </div>
